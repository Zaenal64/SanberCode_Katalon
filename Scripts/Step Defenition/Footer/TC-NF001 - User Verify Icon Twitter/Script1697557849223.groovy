...
WebUI.callTestCase(findTestCase('Pages/Click_Footer/Click_Twitter/Verify_Element_Twitter'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Click_Footer/Click_Twitter/Click_Icon_Twitter'), [:], FailureHandling.STOP_ON_FAILURE)
