...
WebUI.callTestCase(findTestCase('Pages/Click_Footer/Click_Facebook/Verify_Element_Facebook'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Click_Footer/Click_Facebook/Click_Icon_Facebook'), [:], FailureHandling.STOP_ON_FAILURE)
